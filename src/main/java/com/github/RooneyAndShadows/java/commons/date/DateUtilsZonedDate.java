...
public class DateUtilsZonedDate {
    ...
    public static boolean isDayToday(ZonedDateTime testDate) {
        return isDateEqual(testDate, com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.now(testDate.getZone()), false);
    }

    public static boolean isDayYesterday(ZonedDateTime testDate) {
        ZonedDateTime yesterdayDate = com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.incrementDate(com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.now(testDate.getZone()), PeriodTypes.DAY, -1, 0);
        return isDateEqual(testDate, yesterdayDate, false);
    }

    public static boolean isDayTomorrow(ZonedDateTime testDate) {
        ZonedDateTime tomorrowDate = com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.incrementDate(com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.now(testDate.getZone()), PeriodTypes.DAY, 1, 0);
        return isDateEqual(testDate, tomorrowDate, false);
    }

    public static boolean isDayAfterTomorrow(ZonedDateTime testDate) {
        ZonedDateTime dayAfterTomorrowDate = com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.incrementDate(com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.now(testDate.getZone()), PeriodTypes.DAY, 2, 0);
    ...
    public static boolean isDateEqual(ZonedDateTime testDate, ZonedDateTime target, boolean withTime) {
        ...
        if (!withTime) {
            testDate = com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.setTimeToDate(testDate, 0, 0, 0);
            target = com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.setTimeToDate(target, 0, 0, 0);
        }
        return testDate.compareTo(target) == 0;
    }
    ...
    public static List<ZonedDateTime> getAllMonthsForYear(int year) {
        ...
        for (int i = 1; i <= 12; i++) {
            ZonedDateTime newDate = com.github.rooneyandshadows.java.commons.date.DateUtilsZonedDate.date(year, i, 1);
            months.add(newDate);
        }
        return months;
    }
