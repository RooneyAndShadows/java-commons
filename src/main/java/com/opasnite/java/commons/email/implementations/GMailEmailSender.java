package com.opasnite.java.commons.email.implementations;
...
import com.opasnite.java.commons.email.Address;
import com.opasnite.java.commons.email.EmailDeliveryReport;
import com.opasnite.java.commons.email.EmailMessage;
import com.opasnite.java.commons.email.IEmailSender;
...
public class GMailEmailSender implements IEmailSender {
    ...
    private void initialize() throws ServiceInitializationErrorException {
